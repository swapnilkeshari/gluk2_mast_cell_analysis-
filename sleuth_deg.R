...
## qval:  threshold for significance
...
for(i2 in 1:length(testsToRun)){
  ## Common steps regardless of sleuth test
...
### Plotting DEG analysis : Generating and Saving Plots (ORA) ----
